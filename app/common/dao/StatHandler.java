...
public class StatHandler {
	...
	public static String stat(final String sql,String dbSource){
		Logger.debug("executeStatSql.executeStatSql->%s", sql);
		 return Dal.getConnection(dbSource, new ConnectionHandler(){
				@Override
	...
	public static String stat(final String sql,final List<SqlParam> sqlParams,String dbSource){
		 Logger.debug("executeStatSql.executeStatSql->%s", sql);
		 return Dal.getConnection(dbSource, new ConnectionHandler(){
				@Override
				public String handle(Connection connection) throws Exception {
